...
SECRET_KEY = 'django-insecure-6$bo&1vmu2ydf*tb^27492xt3dx27kpgn-cso2954t)fxkv2l*'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],
        'APP_DIRS': True,  # This allows Django to automatically find templates in your app directories
        'OPTIONS': {
            'context_processors': [
